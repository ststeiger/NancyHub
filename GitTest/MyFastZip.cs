...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class FastZip
    {
        ...
        public static void CreateExe(String zipFilename, String outputName)
        {
            ...
            if (outputName == null)
            {
                outputName = Path.ChangeExtension(zipFilename, ".exe");
            }
            ...
            FileStream Zip = new FileStream(zipFilename, FileMode.Open, FileAccess.Read);
            FileStream exe = new FileStream(outputName, FileMode.Create, FileAccess.Write);
